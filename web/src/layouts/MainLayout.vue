  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <div class="q-gutter-sm row items-center no-wrap">
          ...
          <q-btn color="secondary" @click="authStore.logout()" label="Logout" />
        </div>
      </q-toolbar>
    </q-header>
    ...
    >
      <q-list>
        ...
        <q-item to="/UserDashboard" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="dashboard"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/DashboardList" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="dashboard"/>
          </q-item-section>
          <q-item-section>
